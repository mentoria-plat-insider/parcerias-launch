...
export const registrations = mysqlTable(
  "registrations",
  {
    ...
    launchHistoryCount: int("launchHistoryCount"),
    revenueLevel: varchar("revenueLevel", { length: 120 }),
    launchDuration: varchar("launchDuration", { length: 120 }),
    mainDifficulties: text("mainDifficulties"),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
    updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  },
  table => [
...
export const projects = mysqlTable(
  "projects",
  {
    ...
    maturity: mysqlEnum("maturity", ["structuring", "checked_up", "validated", "launched", "launched_validated"]).notNull(),
